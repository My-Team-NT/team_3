...
import {authGuard, roleGuard, createCategory} from '../middlewares/index.js'
...
categoryRouter.post("/add",authGuard, roleGuard("admin"), createCategory ,createCategoryController)
